...
public class Main {
	...
	public static void main(String[] args) {
		...
		equipos.add(new Pais("Qatar", 2, false, "A")); // 0
		equipos.add(new Pais("Ecuador", 3, false, "A")); // 1
		equipos.add(new Pais("Senegal", 1, false, "A")); // 2
		equipos.add(new Pais("Paises Bajos", 5, false, "A")); // 3
		...
		while (!salir) {
			...
			System.out.println("2. Fase de grupos y seleccion de octavos.\n");
